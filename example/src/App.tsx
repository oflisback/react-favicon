...
] as { animated?: boolean; name: string; url: string }[]
...
const App = () => {
  ...
  const [url, setUrl] = useState<string | string[]>(favicons[0].url)
      ...
      >
        <div>
          {favicons.map((favicon) => (
            <div key={JSON.stringify(favicon.url)} style={{ display: 'flex' }}>
              <div
                style={{
          ...
          <div style={{ alignItems: 'center', display: 'flex' }}>
            {[16, 32, 57, 72, 96, 114, 120, 128, 144, 152, 180, 192, 195].map(
              (size) => (
                <div
                  key={size}
                  ...
                  style={{
                    border:
                      iconSize === size ? '2px solid black' : '1px solid black',
                    margin: '2px',
                    width: '25px',
                    height: '20px',
                  }}
